...
import { createTestAccount, createTestRule, testAutomation, startSession } from '../lib/mvp-api';
export default function MvpDashboard() {
    ...
    const handleStartSession = async (accountId) => {
        try {
